...
if sum1Final1==1:
  print( "{} will/was a lucky year".format(year1))

else:
  print ("{} will/was unfourtunatly not a lucky year".format(year1))

if sum1Final1==1:
  print("{} will/was a lucky year".format(year2))
else:
  print ("{} will/was unfourtunatly not a lucky year".format(year2))
